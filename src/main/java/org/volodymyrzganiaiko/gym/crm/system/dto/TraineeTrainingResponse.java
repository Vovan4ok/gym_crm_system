...
@Schema(description = "Training session as seen from the trainee side")
public record TraineeTrainingResponse(
        ...
        @Schema(description = "Username of the trainer who conducted the session", example = "Tra.Iner")
        String trainerName) {
}